...
const steps = [/*'0_updateMetadata', '1_type', '2_activeness', '3_operator', */'4_profitability']
...
const createTaxonomy = (blocknumber) => {
    ...
    const timestampDay = Math.floor(timestamp / 86400) * 86400
    console.log(timestamp)
    sqlCommands.map(sql => sql({blocknumber, timestamp, timestampDay}))
}
init()
createTaxonomy()
