...
const init = requireSQL('3_taxonomy/taxonomizer/taxonomy/pre_init.sql')
const getTimestamp = requireSQL('3_taxonomy/taxonomizer/taxonomy/util_getTimestamp.sql')
const getMaxBlocknumber = requireSQL('3_taxonomy/taxonomizer/taxonomy/util_getMaxBlocknumber.sql')
const getAllTaxonomyBlocknumbers = requireSQL('3_taxonomy/taxonomizer/taxonomy/util_getAllTaxonomyBlocknumbers.sql')
...
const sqlCommands = steps.map(s => requireSQL('3_taxonomy/taxonomizer/taxonomy/'+s+".sql"))
